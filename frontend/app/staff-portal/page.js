    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-16 bg-gradient-to-br from-primary-50 via-white to-gold-50">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-primary-900 mb-3">Staff Portal Login</h1>
          <p className="text-gray-700">Secure access for teachers and school staff to manage records and class activities.</p>
        </div>
      </section>
